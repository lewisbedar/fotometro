<aside class="map-context-panel map-glass" x-show="selectedLine && ! selectedStation" x-transition x-cloak aria-labelledby="line-panel-title">
    <template x-if="selectedLine && ! selectedStation">
        <div>
            <div class="flex items-start justify-between gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 id="line-panel-title" class="text-2xl font-semibold" x-text="selectedLine.name"></h2>
            ...
            <dl class="mt-5 space-y-3 text-sm">
                ...
                <div class="flex justify-between gap-4"><dt>Documentees</dt><dd class="font-semibold" x-text="selectedLine.progress?.documented ?? 0"></dd></div>
                ...
                <div class="flex justify-between gap-4"><dt>Non commencees</dt><dd class="font-semibold" x-text="selectedLine.progress?.not_started ?? 0"></dd></div>
