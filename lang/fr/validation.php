...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute donné apparaît dans une fuite de données connue. Merci d’en choisir un autre.',
    ],
    ...
    */
    'custom' => [
        'username' => [
            'regex' => 'L’identifiant ne peut contenir que des lettres minuscules, chiffres et tirets.',
        ],
    ],
    ...
    */
    'attributes' => [
        ...
        'copyright_display_name' => 'nom affiché pour le copyright',
        'copyright_holder' => 'titulaire des droits',
        'copyright_notice' => 'mention de copyright',
        'credit_line' => 'crédit',
        'usage_terms' => 'conditions d’utilisation',
        ...
        'photos' => 'photos',
        'station_id' => 'station',
        'station_access_id' => 'accès',
        'photo_category_ids' => 'catégories',
